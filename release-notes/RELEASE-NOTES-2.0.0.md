> **Historical.** These are the notes for Classica Codex 2.0.0, which is no longer
...
> Any download link or SHA-256 below refers to the 2.0.0 ZIP, not to the current
