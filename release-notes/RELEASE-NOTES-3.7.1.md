> **Historical.** These are the notes for Classica Codex 3.7.1, which is no longer
...
> Any download link or SHA-256 below refers to the 3.7.1 ZIP, not to the current
