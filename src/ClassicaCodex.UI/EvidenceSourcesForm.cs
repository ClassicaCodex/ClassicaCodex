...
public sealed class EvidenceSourcesForm : Form
{
    ...
    private EvidencePageAnnotation? CurrentAnnotation => _annotations.CurrentRow?.DataBoundItem as EvidencePageAnnotation;
